...
Any file has its own history view, and blame is available for tracking down
when a line changed and why. The in-repository file browser gives you a
read-only tour of the tree at any point, with a guarded text editor when you
do need to change something.
