...
**AI actions** in that header opens the same popup as the commit menu, on
Short description.
...
The same in-app agents can describe selected commits or the working tree —
a short summary, an implementation comment, release notes, a review, or a
test plan. Right-click the selection or press
