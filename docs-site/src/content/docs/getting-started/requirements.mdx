...
| Cursor Origin pull requests | [Origin CLI](https://cursor.com/docs/origin/cli) signed in via `origin auth login` (macOS, Linux, or WSL — not native Windows) |
| AI-drafted commit messages, [AI actions](/guides/ai-actions), conflict resolve | An AI CLI on your `PATH` — `claude`, `codex`, and similar |
