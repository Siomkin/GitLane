// GitHub-flavored markdown renderer for PR descriptions. Uses react-markdown
// (which does NOT render raw HTML by default — safe for untrusted PR bodies)
// plus remark-gfm for tables, task lists, strikethrough and autolinks. Element
// styling is mapped to the app theme; links open in the OS browser via the
// opener plugin rather than navigating the Tauri webview.
