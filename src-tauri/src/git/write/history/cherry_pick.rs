...
/// instead of leaving a half-applied mess mid-loop. Merge commits get `-m 1`,
/// so the applied delta is against the first parent — the branch merged
/// *into*, matching the graph's first-parent lane semantics.
///
