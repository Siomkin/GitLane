...
#[tauri::command]
pub async fn list_signing_keys() -> Result<Vec<SigningKey>, String> {
    blocking(|| Ok(signing_keys::list())).await
}

#[tauri::command]
pub fn repo_identity(path: String) -> Result<Option<RepoIdentity>, String> {
...
#[tauri::command]
pub async fn clear_repo_identity(path: String) -> Result<String, String> {
