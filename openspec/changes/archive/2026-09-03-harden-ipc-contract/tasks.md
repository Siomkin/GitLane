...
- [x] 8.2 Exercise in `bun run tauri dev`: clone with progress, hand-off between worktrees, PTY session, GitHub sign-in; verify each progress checklist still ticks through `listenTyped`
