# forge/origin Specification

## Purpose

Lets GitLane recognise Cursor Origin remotes and open, inspect, and manage their pull requests and existing review threads through the user's Origin CLI session without storing Origin credentials.
